...
{   
    // a class which is named 'Novel' has interited from the abstract class 'Book'
    public class Novel : Book
    {
        ...
        // type of the books in this class is Novel and cannot be changed
        private string _type = "Novel";
